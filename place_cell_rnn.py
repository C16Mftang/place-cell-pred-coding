...
parser = argparse.ArgumentParser(description='Place Cell RNN Training')

# Training hyperparameters to fully reproduce Sorscher et al. 2023
parser.add_argument('--device', type=str, default='cuda:0' if torch.cuda.is_available() else 'cpu', help='Device to use for training')
parser.add_argument('--oned', type=bool, default=False, help='Whether to use one-dimensional place cells')
...
parser.add_argument('--DoG', type=bool, default=True, help='Whether to use Difference of Gaussians for place cell RFs')
...
parser.add_argument('--periodic', type=bool, default=True, help='Whether the environment is periodic')
...
parser.add_argument('--preloaded_data', type=bool, default=False, help='Whether to use preloaded data')
...
parser.add_argument('--is_wandb', type=bool, default=False, help='Whether to use wandb for logging')
