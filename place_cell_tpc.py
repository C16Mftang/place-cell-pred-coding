...
parser.add_argument('--oned', type=bool, default=False, help='Use one-dimensional place cells')
...
parser.add_argument('--DoG', type=bool, default=True, help='Use Difference of Gaussians for place cell receptive fields')
...
parser.add_argument('--periodic', type=bool, default=True, help='Use periodic boundary conditions')
...
parser.add_argument('--preloaded_data', type=bool, default=False, help='Use preloaded data for training')
...
parser.add_argument('--is-wandb', type=bool, default=False, help='Use wandb for logging')
